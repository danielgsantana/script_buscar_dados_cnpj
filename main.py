...
if entrada == 1:
    ...
    aba_ativa['M1'] = 'TEMPO DE EXECUÇÃO'
    ...
    for item in empresa_nome_list:
        ...
        while True:
            try:       
                ...
                driver.find_element(By.XPATH, '/html/body/div/main/div/div/a/p').click()
...
if entrada == 2:
    ...
    empresa_cnpj_list = funcoes.capturar_cnpj(aba_ativa)
    ...
    for item in empresa_cnpj_list:

        empresa_json = funcoes.buscar_cnpj_api(item)

        funcoes.adicionar_dados_planilha(item, empresa_json, planilha, row)
